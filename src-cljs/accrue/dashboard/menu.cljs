(ns accrue.dashboard.menu
  (:require [reagent.core :as reagent]
            [centipair.core.ui :as ui]
            [centipair.core.components.notifier :as notify]
            [accrue.insights.almanac.screener :as almanac-screener]
...
(def admin-menu (reagent/atom 
                 [{:label "Dashboard" :url "/dashboard" :id "dashboard" :active false}
                  {:label "Almanac" :url "/almanac" :id "almanac" :active false }
...
(defroute screening "/almanac" []
  (activate-side-menu-item "almanac")
  (js/console.log "almanac")
  (almanac-screener/render-screener-ui)
  )
